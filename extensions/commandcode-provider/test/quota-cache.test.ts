...
const quota = {
	fiveHour: { used: 24, cap: 100, exceeded: false },
	weekly: null,
};
const success: CommandCodeQuotaResult = { status: "success", quota };
...
test("a successful quota result clears the backoff state", () => {
